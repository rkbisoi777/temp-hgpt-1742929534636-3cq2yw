...
Regarding the property titled "${property.title}", located at ${property.location}, price starts from ₹${property.price_min} to ₹${property.price_min}, featuring ${property.bedrooms_min} bedrooms, and ${property.sqft_min} sqft:
